...
<body>
  <header class="bg-white fixed-top border-bottom">
	...
	<div class="container-fluid p-2"
		...
		<div class="container">
			<h5 class="">
				<a href="../home/home.htm"><i class="fa fa-home"></i></a> <a
					href="../home/don-hang-cua-toi.htm"> >Lịch sử đặt hàng</a> > Xem
				chi tiết đơn hàng
			</h5>
		</div>
	</div>
			...
			<div class="col-md-12">
				<div class="tile">
					<div class="tile-body">
						<div class="row element-button">
							<div class="col-sm-2">
								<a class="btn btn-add btn-sm"
									href="../home/donhangchoxacnhan.htm" title="Thêm"><i
									class="fas fa-plus"></i> Chờ xác nhận</a>
							</div>
							<div class="col-sm-2">
								<a class="btn btn-add btn-sm"
									href="../home/donhangdaxacnhan.htm" title="Thêm"><i
						...
						<c:url value="../home/donhangchoxacnhan.htm" var="pagedLink">
								...
								<c:forEach var="gh" items="${pagedListHolder.pageList}">
									<tr>
										...
										<td class="text-center"><a
											href="../home/${gh.maGioHang}.htm?linkChiTiet2">
  ...
  <path
										...
										<td class="text-center"><a
											href="../admin/${gh.maGioHang}.htm?linkHoaDonKH">
												<button class="btn btn-primary btn-sm">
													<svg xmlns="http://www.w3.org/2000/svg" width="16"
														height="16" fill="currentColor" class="bi bi-eye"
														viewBox="0 0 16 16">
