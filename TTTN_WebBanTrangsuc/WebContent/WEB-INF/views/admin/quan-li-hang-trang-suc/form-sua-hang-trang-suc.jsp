...
<head>
<title>Sửa hãng trang sức | Quản trị Admin</title>
<meta charset="utf-8">
...
.removeimg::after {
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#">Sửa hãng trang sức</a></li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				<h3 class="tile-title">Sửa hãng trang sức</h3>
				<div class="tile-body">
					<form:form action="../adminTS/suahangtrangsuc.htm" modelAttribute="hangTS">
						<div class="row">
