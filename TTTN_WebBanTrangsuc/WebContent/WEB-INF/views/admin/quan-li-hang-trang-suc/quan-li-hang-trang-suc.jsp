...
<head>
<title>Danh sách hãng trang sức | Quản trị trang sức</title>
<meta charset="utf-8">
					...
					<div class="row element-button">
						<div class="col-sm-2">
							...
							<a class="btn btn-add btn-sm"
								href="../adminTS/form-add-hang-trang-suc.htm" title="Thêm"><i
								class="fas fa-plus"></i> Tạo mới hãng trang sức</a>
						</div>

					</div>
					<c:url value="quan-li-hang-trang-suc.htm" var="pagedLink">
						...
						<tbody>
							<c:forEach var="ts" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td><a href="../adminTS/${ts.maHang}.htm?linkEditHangTS"
										rel="stylesheet"><img
											<%-- ${us.idUser} --%>
													width="31" height="31"
											src="<c:url value='/resources/img/edit.png'/>" /></a></td>
									<td><a name="btnDelete"
										href="../adminTS/${ts.maHang}.htm?linkDeleteHangTS" rel="stylesheet"
