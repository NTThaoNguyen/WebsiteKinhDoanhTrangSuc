	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="tile">
					...
					<div class="row element-button">
						<div class="col-sm-2">
							...
							<a class="btn btn-add btn-sm"
								href="../adminTK/form-add-tai-khoan.htm" title="Thêm"><i
								class="fas fa-plus"></i> Tạo mới tài khoản nhân viên</a>
						</div>
					</div>
					<form:form action="../adminTK/themnhanvien.htm" modelAttribute="nhanvien">
						<div class="row">
							<div class="form-group col-md-4">
								<label class="control-label">Mã nhân viên</label> <label
									style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="maNV" type="text" />
								<form:errors path="maTK" style="color: red; font-size: 12px;"></form:errors>
							</div>
							<div class="form-group col-md-4">
								<label class="control-label">Họ và tên lót</label> <label
									style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="ho" type="text" />
							...
							<div class="form-group  col-md-4">
								<label class="control-label">Email</label> <input
									class="form-control" type="email"> <label
									style="color: red;">&nbsp *</label>
				...
				<a class="btn btn-cancel" href="../adminTK/quan-li-nhan-vien.htm">Hủy
					bỏ</a>
			</div>
		</div>
	</div>
