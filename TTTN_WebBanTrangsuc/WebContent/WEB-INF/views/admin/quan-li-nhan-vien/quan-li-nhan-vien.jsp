...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			<li class="breadcrumb-item active"><a href="../admin/quan-li-nhan-vien.htm"><b>Danh
					...
					<div class="row element-button">
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm"
								href="../adminTK/form-add-nhan-vien.htm" title="Thêm"><i
						...
						<tbody>
							<c:forEach var="nv" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td>${nv.gioiTinh}</td>
									<td>${nv.sdt}</td>
									<td><a href="../admin/${nv.maNV}.htm?linkPrice"
										rel="stylesheet"><img
											<%-- ${us.idUser} --%>
													width="31" height="31"
											src="<c:url value='/resources/img/account.webp'/>" /></a></td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<a class="btn btn-cancel" data-dismiss="modal"
						href="../admin/quan-li-nhan-vien.htm">Hủy bỏ</a> <BR>
				</div>
