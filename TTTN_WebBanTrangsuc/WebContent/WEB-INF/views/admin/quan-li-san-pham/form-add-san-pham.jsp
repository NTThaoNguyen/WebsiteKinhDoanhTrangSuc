		...
		<div class="col-md-12">
			<div class="tile">
				...
				<div class="tile-body">
					...
					<form:form class="row" action="../adminTS/themTrangSuc.htm"
						modelAttribute="trangsuc">
						<div class="form-group col-md-3">
							<label class="control-label">Mã sản phẩm </label>
							<label style="color: red;">&nbsp *</label>
							<form:input class="form-control" path="maTS" type="text" />
							<form:errors path="maTS" style="color: red; font-size: 12px;"></form:errors>
						</div>
						<div class="form-group col-md-3">
							<label class="control-label">Tên sản phẩm</label>
							<label style="color: red;">&nbsp *</label>
							<form:input class="form-control" path="tenTS" type="text" />
							<form:errors path="tenTS" style="color: red; font-size: 12px;"></form:errors>
						</div>
						...
						<div class="form-group  col-md-3">
							...
							<form:errors path="soLuongTon" style="color: red; font-size: 12px;"></form:errors>
						</div>
						<div class="form-group col-md-3 ">
						...
						<div class="form-group col-md-12">
							...
							<form:errors path="moTa" style="color: red; font-size: 12px;"></form:errors>
						</div>
