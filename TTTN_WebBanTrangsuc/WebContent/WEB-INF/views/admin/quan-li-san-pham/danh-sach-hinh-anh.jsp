...
<head>
<title>Danh sách hình ảnh của sản phẩm ${name} | Quản trị Admin</title>
<meta charset="utf-8">
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			<li class="breadcrumb-item active"><a href="#"><b>Danh
						sách hình ảnh của sản phẩm ${name}</b></a></li>
		</ul>
		<div id="clock"></div>
	</div>
	<div class="row">
			...
			<div class="tile">
				<div class="tile-body">
					<div class="row element-button">
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm" href="../admin/them.htm"
								title="Thêm"><i class="fas fa-plus"></i> Thêm hình ảnh</a>
						</div>
					</div>
					<table class="table table-hover table-bordered" id="sampleTable">
						...
						<tbody>
							<c:forEach var="hinhAnh" items="${dSHinhAnh}">
								<tr>
									<%-- <td>${hinhAnh.maTS.maTS}</td> --%>
									<td class="text-center">
										<div style="width: 150px; height: 140px;">
											<img src="${hinhAnh.tenHA}" class="img-fluid" alt="Image"
												style="width: 150px; height: 140px;">
										</div>
									</td>
									<td class="text-center"><a name="btnDelete"
										href="../admin/${hinhAnh.maHA}.htm?linkDeleteHinhAnh" rel="stylesheet"
