	...
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				...
				<div class="tile-body">
					<form:form action="../admin/themHinhAnh.htm" modelAttribute="hinhAnh">
						<div class="row">							
							<div class="form-group col-md-4">
								<label class="control-label">Tên đường dẫn</label>
								<label style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="tenHA" type="text" />
								<form:errors path="tenHA" style="color: red; font-size: 12px;"></form:errors>
							</div>
						</div>
