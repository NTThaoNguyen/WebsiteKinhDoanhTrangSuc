...
<head>
<title>Danh sách giá | Quản trị Admin</title>
<meta charset="utf-8">
...
.removeimg::after {
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb">
			<li class="breadcrumb-item">Danh sách giá sản phẩm</li>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				<h3 class="tile-title">Thêm khuyến mãi</h3>
				<div class="tile-body">
					<form:form action="../admin/themKhuyenMai.htm" modelAttribute="khuyenMai">
						<div class="row">							
							
      						
      						<div class="form-group col-md-3">
								<label class="form-label"><b>Ngày bắt đầu</b></label><label
									style="color: red;">&nbsp *</label>
								<div class="input-group date" id="datepicker">
									<input path="ngayBD" type="text" class="form-control" >
							...
							<div class="form-group col-md-3">
								<label class="form-label"><b>Ngày kết thúc</b></label><label
									style="color: red;">&nbsp *</label>
								<div class="input-group date" id="datepicker">
									<input path="ngayKT" type="text" class="form-control" >
									<span class="input-group-append"> <span
										class="input-group-text bg-light d-block"> <i
											class="fa fa-calendar"></i>
									</span>
							...
							<%-- <div class="form-group col-md-3">
								...
								<form:input class="form-control" path="phanTramGiam" type="text" />
							</div> --%>
							<div class="form-group col-md-12">
								<label class="control-label">Mô tả </label><label style="color: red;">&nbsp *</label>
								<textarea class="form-control" path="moTa" rows="2"></textarea>
							</div>
						</div>
