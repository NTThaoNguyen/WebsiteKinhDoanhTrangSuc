		...
		<div class="col-md-12">
			<div class="tile">
				<div class="tile-body">
					<div class="row element-button">
						...
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm"
								href="../adminTS/form-add-san-pham.htm" title="Thêm"><i
								class="fas fa-plus"></i> Tạo mới trang sức</a>
						</div>
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm"
								href="../adminTS/form-add-khuyen-mai.htm" title="Thêm"><i
								class="fas fa-plus"></i> Thêm khuyến mãi</a>
						</div>
						<div class="col-sm-2">
					...
					<c:url value="quan-li-san-pham.htm" var="pagedLink">
					...
					<table class="table table-hover table-bordered" id="sampleTable">
						<thead>
							<tr>
								...
								<th class="text-center">Loại trang sức</th>
								<th class="text-center">Hãng trang sức</th>
								<!-- <th>Giá tiền</th> -->
								<th class="text-center">Quản lý giá</th>
								<th class="text-center">Quản lý ảnh</th>
								<th class="text-center">Sửa</th>
								<th class="text-center">Xóa</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="ts" items="${pagedListHolder.pageList}">
								<tr>
									<!-- <td width="10"><input type="checkbox" name="check1"
										value="1"></td> -->
									<td class="text-center">${ts.maTS}</td>
									<td class="text-center">${ts.tenTS}</td>
									<td class="text-center">${ts.soLuongTon}</td>
									<td class="text-center"><span class="badge bg-success">${ts.trangThaiSP}</span></td>
									<td class="text-center">${ts.maLoai.tenLoai}</td>
									<td class="text-center">${ts.maHang.tenHang}</td>
									<!-- <td>${ts.gia}</td> -->
									<td class="text-center"><a href="../admin/${ts.maTS}.htm?linkPrice"
										rel="stylesheet"><img
											<%-- ${us.idUser} --%>
													width="31" height="31"
											src="<c:url value='/resources/img/price.jfif'/>" /></a></td>
									<td class="text-center"><a href="../admin/${ts.maTS}.htm?linkImage"
										rel="stylesheet"><img
											<%-- ${us.idUser} --%>
													width="31" height="31"
											src="<c:url value='/resources/img/image.jpg'/>" /></a></td>
									<td class="text-center"><a
										href="../adminTS/${ts.maTS}.htm?linkEditTS"
										rel="stylesheet"><img
													width="31" height="31"
											src="<c:url value='/resources/img/edit.png'/>" /></a></td>
									<td class="text-center"><a name="btnDelete"
										href="../adminTS/${ts.maTS}.htm?linkDeleteTS"
