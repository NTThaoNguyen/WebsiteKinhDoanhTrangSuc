...
.removeimg::after {
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#">Thêm giá</a></li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				<h3 class="tile-title">Thêm giá</h3>
				<div class="tile-body">
					<form:form action="../admin/themGiaTS.htm" modelAttribute="giaTS">
						<%-- <div class="row">
							<div class="form-group col-md-4">
								<label class="control-label">Ngày áp dụng</label>
								</label><label style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="ngayApDung" type="text" />
						...
						<div class="form-group col-md-3">
							<label class="control-label">Giá</label> <label
								style="color: red;">&nbsp *</label>
							<form:input class="form-control" path="gia" type="text" />
