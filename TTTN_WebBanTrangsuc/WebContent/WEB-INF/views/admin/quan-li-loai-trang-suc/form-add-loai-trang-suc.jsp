...
<head>
<title>Thêm loại trang sức | Quản trị Admin</title>
<meta charset="utf-8">
...
.removeimg::after {
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb">
			<li class="breadcrumb-item">Danh sách loại trang sức</li>
			<li class="breadcrumb-item"><a href="#">Thêm loại trang sức</a></li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				<h3 class="tile-title">Tạo mới loại trang sức</h3>
				<div class="tile-body">
					<form:form action="../adminTS/themLoaiTrangSuc.htm"
						modelAttribute="loaiTS">
						<div class="row">
							<div class="form-group col-md-4">
								<label class="control-label">Mã loại</label> </label><label
									style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="maLoai" type="text" />
								<form:errors path="maLoai" style="color: red; font-size: 12px;"></form:errors>
							</div>
							<div class="form-group col-md-4">
								<label class="control-label">Tên loại</label> </label><label
									style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="tenLoai" type="text" />
								<form:errors path="tenLoai" style="color: red; font-size: 12px;"></form:errors>

							</div>
						</div>

						<button class="btn btn-save">Lưu lại</button>
						<a class="btn btn-cancel" data-dismiss="modal" href="../adminTS/quan-li-loai-trang-suc.htm">Hủy bỏ</a>
					</form:form>
