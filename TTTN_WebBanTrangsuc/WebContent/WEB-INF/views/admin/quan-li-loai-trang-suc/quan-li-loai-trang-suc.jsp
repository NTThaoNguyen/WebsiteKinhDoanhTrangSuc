...
<head>
<title>Danh sách loại trang sức | Quản trị trang sức</title>
<meta charset="utf-8">
					...
					<div class="row element-button">
						<div class="col-sm-2">
							...
							<a class="btn btn-add btn-sm"
								href="../adminTS/form-add-loai-trang-suc.htm" title="Thêm"><i
								class="fas fa-plus"></i> Tạo mới loại trang sức</a>
						</div>

					</div>
					<c:url value="quan-li-loai-trang-suc.htm" var="pagedLink">
						...
						<tbody>
							<c:forEach var="ts" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td><a href="../adminTS/${ts.maLoai}.htm?linkEdit"
										rel="stylesheet"><img
											<%-- ${us.idUser} --%>
													width="31" height="31"
											src="<c:url value='/resources/img/edit.png'/>" /></a></td>
									<td><a name="btnDelete"
										href="../adminTS/${ts.maLoai}.htm?linkDeleteLoaiTS" rel="stylesheet"
