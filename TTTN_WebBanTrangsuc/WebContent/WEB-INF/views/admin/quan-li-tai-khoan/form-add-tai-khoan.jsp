...
<head>
<title>Thêm tài khoản | Quản trị Admin</title>
<meta charset="utf-8">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				...
				<div class="tile-body">
					<form:form action="../adminTK/themtaikhoan.htm" modelAttribute="user">
						<div class="row">
							<div class="form-group col-md-4">
								<label class="control-label">Mã tài khoản</label> 
								<label style="color: red;">&nbsp *</label>
								<form:input class="form-control" path="maTK" type="text" />
						...
						<!-- <a class="btn btn-cancel" data-dismiss="modal" href="../admin/form-add-nhan-vien.htm">Hủy bỏ</a> -->
					</form:form>
