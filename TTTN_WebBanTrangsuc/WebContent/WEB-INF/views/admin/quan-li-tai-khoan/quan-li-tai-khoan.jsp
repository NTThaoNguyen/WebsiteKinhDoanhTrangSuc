...
<head>
<title>Danh sách tài khoản | Quản trị tài khoản</title>
<meta charset="utf-8">
...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<aside class="app-sidebar">
		...
		<ul class="app-menu">
			...
			<li><a class="app-menu__item active"
				href="../adminTK/quan-li-tai-khoan.htm"><i
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			<li class="breadcrumb-item active"><a href="../adminTK/quan-li-tai-khoan.htm"><b>Danh
		...
		<div class="col-md-12">
			<div class="tile">
				<div class="tile-body">
					...
					<c:url value="quan-li-tai-khoan.htm" var="pagedLink">
							...
							<c:forEach var="tk" items="${pagedListHolder.pageList}">
								<tr>
									<td width="10"><input type="checkbox" name="check1"
										value="1"></td>
									<td>${tk.maTK}</td>
									<td>${tk.maQuyen.tenQuyen}</td>
									<td>${tk.email}</td>
									<td>${tk.password}</td>
									<td>${tk.maTrangThaiTK.tenTrangThaiTK}</td>
									...
									<td><a
										href="../adminTk/${tk.maTK}.htm?linkEdit"
										rel="stylesheet"><img
											<%-- ${us.idUser} --%>
													width="31" height="31"
											src="<c:url value='/resources/img/edit.png'/>" /></a></td>
									<td><a name="btnDelete"
										href="../adminTK/${tk.maTK}.htm?linkDelete"
