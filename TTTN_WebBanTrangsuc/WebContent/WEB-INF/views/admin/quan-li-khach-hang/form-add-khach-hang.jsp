	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="tile">
					...
					<div class="row element-button">
						<div class="col-sm-2">
							...
							<a class="btn btn-add btn-sm"
								href="../adminTK/form-add-tai-khoan.htm" title="Tạo mới tài khoản khách hàng"><i
								class="fas fa-plus"></i> Tạo mới tài khoản khách hàng</a>
						</div>
					</div>
					<form class="row">
				...
				<a class="btn btn-cancel" href="../adminTK/quan-li-khach-hang.htm">Hủy
					bỏ</a>
			</div>
	</main>
