...
<body onload="time()" class="app sidebar-mini rtl">
		...
		<ul class="app-menu">
			...
			<li><a class="app-menu__item"
				href="../admin/quan-li-don-hang.htm"><i
					...
					class="app-menu__label active">Quản lý đơn hàng</span></a></li>
			<li><a class="app-menu__item"
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb">
			...
			<li class="breadcrumb-item"><a href="../admin/form-add-don-hang">Thêm đơn hàng</a></li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-12">
					...
					<form class="row">
						<div class="form-group  col-md-4">
							<label class="control-label">ID đơn hàng ( Nếu không nhập
								sẽ tự động phát sinh )</label> <input class="form-control" type="text">
						</div>
						<div class="form-group  col-md-4">
