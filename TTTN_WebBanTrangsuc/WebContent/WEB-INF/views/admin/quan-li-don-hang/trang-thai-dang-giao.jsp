...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			...
			<li class="breadcrumb-item active"><a href="../admin/dangiao.htm">Trạng thái - Đang giao</a></li>
		</ul>
		<div id="clock"></div>
	</div>
	<div class="row">
			...
			<div class="tile">
				<div class="tile-body">
					<div class="row element-button">
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm" href="../admin/choxacnhan.htm"
								title="Thêm"><i class="fas fa-plus"></i> Chờ xác nhận</a>
						</div>
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm" href="../admin/daxacnhan.htm"
								title="Thêm"><i class="fas fa-plus"></i> Đã xác nhận</a>
						</div>
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm" href="../admin/danggiao.htm"
								title="Thêm"><i class="fas fa-plus"></i> Đang giao</a>
						</div>
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm" href="../admin/danhan.htm"
								title="Thêm"><i class="fas fa-plus"></i> Đã giao</a>
						</div>
						<div class="col-sm-2">
							<a class="btn btn-add btn-sm" href="../admin/dahuy.htm"
								title="Thêm"><i class="fas fa-plus"></i> Đã Hủy</a>
						</div>
					</div>
					...
					<table class="table table-hover table-bordered" id="sampleTable">
						<thead>
							<tr>
								...
								<th class="text-center">Nhân viên giao</th>
								<th class="text-center">Xem chi tiết đơn hàng</th>
								<th class="text-center">Xem hóa đơn</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="gh" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td class="text-center">${gh.soHoaDon.maNV.ho} ${gh.soHoaDon.maNV.ten}</td>
									<td class="text-center">Nguyễn Anh Khoa</td>
									<td class="text-center"><a
										href="../admin/${gh.maGioHang}.htm?linkChiTietDangGiao">
  ...
  <path
									...
									<td class="text-center"><a
										href="../admin/${gh.maGioHang}.htm?linkHoaDon">
											<button class="btn btn-primary btn-sm">
												<svg xmlns="http://www.w3.org/2000/svg" width="16"
													height="16" fill="currentColor" class="bi bi-eye"
													viewBox="0 0 16 16">
