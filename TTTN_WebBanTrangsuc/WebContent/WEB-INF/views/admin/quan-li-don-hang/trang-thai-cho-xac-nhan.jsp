...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			...
			<li class="breadcrumb-item active"><a href="../admin/choxacnhan.htm">Trạng thái - Chờ xác nhận</a></li>
		</ul>
		<div id="clock"></div>
	</div>
	<div class="row">
							...
							<c:forEach var="gh" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td class="text-center"><a
										href="../admin/${gh.maGioHang}.htm?linkChiTiet">
